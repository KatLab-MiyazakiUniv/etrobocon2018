...
/* コンパイル(平木場)
$ g++-7 -w ../src/Pid.cpp ../src/SpeedControl.cpp SpeedControlTest.cpp gtest_main.o gtest-all.o
-I../include -I../../googletest/googletest/include $ ./a.out
*/
...
class test_SpeedControl : public SpeedControl {
 public:
  test_SpeedControl() : SpeedControl() {}
