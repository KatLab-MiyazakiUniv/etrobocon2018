 ...
 * \details      When specifying an incorrect setting value, do not change the color of the LED
 * light. \param color  The color to set \retval E_OK  Successful completion \retval E_PAR Incorrect
 * setting value
 *
 * \~Japanese
